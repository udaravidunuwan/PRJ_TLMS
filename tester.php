                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody class="table-group-divider">
                                    <tr>
                                        ...
                                        <td>
                                            <a data-bs-placement="top" class="btn btn-sm me-3" title="Edit"><i class="bi bi-pen"></i></a>
                                            <a data-bs-placement="top" class="btn btn-sm" title="Delete"><i class="bi bi-trash3"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
