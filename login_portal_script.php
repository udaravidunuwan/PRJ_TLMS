...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#loginSigninBtn").on("click", function(event) {
            event.preventDefault(); // Prevent form submission for now
            Login(); // Call your function
        });
        // end 
    ...
    function Login() {
        $(document).ready(function() {
            var data = {
                action: $('#action').val(),
                emailSignin: $('#loginEmail').val(),
                passwordSignin: $('#loginPassword').val(),
            };
            // alert('check IN');
            // alert(JSON.stringify(data));
            $.ajax({
                url: 'login_portal_functions.php',
                type: 'POST',
                data: data,
