...
<head>
    ...
    <link rel="stylesheet" href="./admin_assets/css/admin_customers.css">
...
<body class="py-0 bg-body-tertiary">
                ...
                <div class="row mt-3">
                    <div class="px-md-4">
                        ...
                        <div class="table-responsive small">
                            <table id="admin_customers_table" class="table table-striped table-sm">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                ...
                                <tbody class="table-group-divider">
                                    <tr>
                                        ...
                                        <td>
                                            <a data-bs-placement="top" class="btn btn-sm pe-2 pb-0 pt-0" title="Edit"><i class="bi bi-pen"></i></a>
                                            <a data-bs-placement="top" class="btn btn-sm pe-2 pb-0 pt-0" title="Delete"><i class="bi bi-trash3"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script src="./admin_assets/js/admin_customers.js"></script>
