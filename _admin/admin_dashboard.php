...
<body class="py-0 bg-body-tertiary">
    ...
    <header class="container-fluid">
        <div class="row">
            ...
            <!-- navbar -->
            <nav class="navbar navbar-expand-sm navbar-expand-lg bg-secondary-subtle" id="navbar_top">
    ...
    <main class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                    ...
                    <div class="px-md-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-2 mb-3 border-bottom">
                            ...
                            <div class="btn-toolbar mb-2 mb-md-0">
                                ...
                                <div class="dropdown">
                                    <button type="button" id="dropdownButton_dashboard-cards" class="btn btn-sm btn-outline-secondary dropdown-toggle d-flex align-items-center gap-1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="row">
                    <div class="px-md-4">
                        <h3 class="pb-3">Latest Jobs</h3>

                        <table id="admin_dashboard_table" class="table table-striped table-sm pt-2">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    <th scope="col">Job</th>
    ...
    <script src="./admin_assets/js/admin_dashboard.js"></script>
