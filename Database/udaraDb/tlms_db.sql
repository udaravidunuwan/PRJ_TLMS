...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2023 at 01:30 PM
...
CREATE TABLE `tlms_system_users` (
  ...
  `tlms_system_users_user_type` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tlms_system_users` (`tlms_system_users_id`, `tlms_system_users_first_name`, `tlms_system_users_last_name`, `tlms_system_users_user_role`, `tlms_system_users_email`, `tlms_system_users_password`, `tlms_system_users_temp_password`, `tlms_system_users_user_type`) VALUES
(1, 'testuser', 'testname', 'Admin', 'testuser@mail.com', NULL, NULL, 0);
...
--
ALTER TABLE `tlms_system_users`
  MODIFY `tlms_system_users_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
